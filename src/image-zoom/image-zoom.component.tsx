...
export default class ImageViewer extends React.Component<Props, State> {
    ...
    public onPanResponderRelease = (evt: any, gestureState: any) => {
    ...
    public onPanResponderMove = (evt: any, gestureState: any) => {
        if (this.isDoubleClick) {
            // 有时双击会被当做位移，这里屏蔽掉
            return;
        }
    ...
    public onPanResponderGrant = (evt: any) => {
        // 开始手势操作
        this.lastPosition = [{ x: 0, y: 0 }, { x: 0, y: 0 }];
    ...
    public componentWillReceiveProps(nextProps: Props) {
        ...
        if (
            ...
            (nextProps.centerOn && this.props.centerOn && this.didCenterOnChange(
                this.props.centerOn,
                nextProps.centerOn
            ))
        ) {
